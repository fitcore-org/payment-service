...
object PlanMapper {
    fun toDomain(dto: PlanRequestDto): Plan = Plan(
        id = null,
        name = dto.name,
    ...
    fun toResponse(plan: Plan): PlanResponseDto = PlanResponseDto(
        id = plan.id ?: "",
        name = plan.name,
    ...
    fun toDomainItem(dto: PlanItemRequestDto): PlanItem = PlanItem(
        name = dto.name,
        description = dto.description,
        quantity = dto.quantity,
    ...
    fun toDomainItem(dto: PlanItemUpdateDto): PlanItem = PlanItem(
        name = dto.name,
        description = dto.description,
        quantity = dto.quantity,
        pricingScheme = toDomainPricingScheme(dto.pricingScheme),
    ...
    fun toDtoItem(item: PlanItem): PlanItemDto = PlanItemDto(
        id = item.id,
        name = item.name,
    ...
    private fun toDomainItem(dto: PlanItemDto): PlanItem = PlanItem(
        id = dto.id,
        name = dto.name,
        description = dto.description,
        quantity = dto.quantity,
    ...
    private fun toDomainPricingScheme(dto: PricingSchemeDto): PricingScheme = PricingScheme(
        schemeType = dto.schemeType,
        price = dto.price
    )

    private fun toDtoPricingScheme(pricingScheme: PricingScheme): PricingSchemeDto = PricingSchemeDto(
